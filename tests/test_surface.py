...
class ToolSurfaceTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        shutil.copytree(SOURCE_ROOT / "kicad_tooling", self.root / "kicad_tooling",
                        ignore=shutil.ignore_patterns("__pycache__"))
        shutil.copytree(TEST_ROOT, self.root / "tests",
                        ignore=shutil.ignore_patterns("__pycache__"))
        ...
        for attribute, value in (("SOURCE_ROOT", self.root),
    ...
    def test_reference_fixture_keeps_surface_policy_in_the_tooling_package(self) -> None:
        ...
        self.assertEqual(self.report().capabilities,
    ...
    def test_new_subcommand_is_detected_on_an_existing_cli(self) -> None:
        self.replace_source("kicad_tooling/hardware.py", '"verify-snapshot"))',
    ...
    def test_new_mcp_tool_requires_snapshot_and_classification(self) -> None:
        self.replace_source(
            "kicad_tooling/hwrepo/mcp_server.py", "    return server\n",
    ...
    def test_mcp_parameter_and_removal_drift_are_detected(self) -> None:
        self.replace_source("kicad_tooling/hwrepo/mcp_server.py", "def list_projects()",
                            "def list_projects(limit: int = 10)")
        self.replace_source("kicad_tooling/hwrepo/mcp_server.py",
    ...
    def test_unsupported_dynamic_declarations_fail_instead_of_disappearing(self) -> None:
        self.replace_source("kicad_tooling/hardware.py",
        ...
        shutil.copy2(SOURCE_ROOT / "kicad_tooling/hardware.py", self.root / "kicad_tooling/hardware.py")
        self.replace_source("kicad_tooling/hwrepo/mcp_server.py",
                            "server.tool(annotations=READ_ONLY)(get_project)",
