...
def main() -> int:
    ...
    if args.native_summary is not None and (mutation or args.init_preferences is not None or args.save_preferences):
                ...
                if args.format == "json":
                    ...
                    if planned is not None:
                        ...
                        if planned.plan_path is not None:
                            ...
                            command = shlex.join(("python", "-B", "-m", "kicad_tooling.parts", "--root", str(root),
        ...
        if args.auto_models or args.cad_plan is not None:
            ...
            if args.format == "json":
                ...
                if cad.plan_path is not None and not args.apply:
                    print(f"Review cad.diff, then: python -B -m kicad_tooling.parts --project {args.project} --cad-plan {cad.plan_path} --apply")
        ...
        if args.init_preferences is not None:
            ...
            if args.format == "json":
                ...
                print(f"Saved preferences: {path}\nEdit reviewed DigiKey SKUs here if needed.\n"
                      "Next: python -B -m kicad_tooling.parts --project " + args.project
